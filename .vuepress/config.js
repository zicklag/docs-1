...
module.exports = {
	...
	head: [
		...
		[
			"link",
			{ rel: "mask-icon", href: "/safari-pinned-tab.svg", color: "#6644ff" },
		],
		[
			"link",
	...
	async extendPageData($page) {
		...
		const lastUpdated = new Date($page.lastUpdated).toLocaleDateString(
			undefined,
			{
				year: "numeric",
				month: "long",
		...
		const readTime = $page._content
			? readingTime($page._content).text
			: undefined;
